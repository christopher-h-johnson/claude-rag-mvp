...
describe('CacheLayer', () => {
    ...
    describe('setCachedResponse', () => {
        it('should cache response with correct TTL', async () => {
            ...
            // Assert
            expect(mockRedis.setex).toHaveBeenCalledWith(expect.stringContaining('bedrock:'), 3600, // 1 hour TTL
            response);
        });
        it('should use consistent hash for same query', async () => {
            // Arrange
    ...
    describe('setCachedSearchResults', () => {
        it('should cache search results with correct TTL', async () => {
            ...
            // Assert
            expect(mockRedis.setex).toHaveBeenCalledWith(expect.stringContaining('search:'), 900, // 15 minutes TTL
    ...
    describe('error handling', () => {
        it('should handle connection failure gracefully', async () => {
            ...
            Redis.mockImplementationOnce(() => failingRedis);
